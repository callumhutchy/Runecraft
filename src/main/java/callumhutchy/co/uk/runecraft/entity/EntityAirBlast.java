...
public class EntityAirBlast extends EntityFireball
    ...
    public EntityAirBlast(World par1World, EntityLivingBase par2EntityLivingBase, double par3, double par5, double par7)
    {
    	super(par1World);
    ...
    public EntityAirBlast(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
